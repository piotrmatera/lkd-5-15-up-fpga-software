...
; C prototype:
; void SINCOS_calc_CPUasm(float (struct trigonometric_struct *sincos_table, float angle);
...
; (KALMAN_HARMONICS+2)*4 instructions without pre-jump
		...
		.if __TI_EABI__
		.asg SINCOS_calc_CPUasm, _SINCOS_calc_CPUasm
		.endif

        .global _SINCOS_calc_CPUasm
        .text
...
;end of function SINCOS_calc_CPUasm()
;*********************************************************************
