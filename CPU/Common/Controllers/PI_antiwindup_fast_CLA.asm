;Tomasz Œwiêchowicz swiechowicz.tomasz@gmail.com
		...
		.if __TI_EABI__
		.asg	PI_antiwindup_fast_CLAasm, _PI_antiwindup_fast_CLAasm
		.endif

		.global _PI_antiwindup_fast_CLAasm
		.def	__cla_PI_antiwindup_fast_CLAasm_sp

SIZEOF_LFRAME	.set	2
LFRAME_MR3		.set	0

__cla_PI_antiwindup_fast_CLAasm_sp	.usect ".scratchpad:Cla1Prog:_PI_antiwindup_fast_CLAasm", SIZEOF_LFRAME, 0, 1
		.asg	 __cla_PI_antiwindup_fast_CLAasm_sp, LFRAME

		.sect 	"Cla1Prog:_PI_antiwindup_fast_CLAasm"

		.align 	2

; C prototype:
; void PI_antiwindup_fast_CLAasm(volatile struct PI_struct *PI, float error);
; 16 instructions without pre-jump

_PI_antiwindup_fast_CLAasm:
;		MDEBUGSTOP
