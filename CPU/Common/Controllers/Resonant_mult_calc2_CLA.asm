...
; argument 2 = harmonics : number of executions [MR0]
; 23*N + 11 instructions without pre-jump

		.cdecls   C,LIST,"Controllers.h"

		.if __TI_EABI__
		.asg	Resonant_mult_calc2_CLAasm, _Resonant_mult_calc2_CLAasm
		.endif

		.global _Resonant_mult_calc2_CLAasm
		.def	__cla_Resonant_mult_calc2_CLAasm_sp
...
__cla_Resonant_mult_calc2_CLAasm_sp	.usect ".scratchpad:Cla1Prog:_Resonant_mult_calc2_CLAasm", SIZEOF_LFRAME, 0, 1
		.asg	 __cla_Resonant_mult_calc2_CLAasm_sp, LFRAME

		.sect 	"Cla1Prog:_Resonant_mult_calc2_CLAasm"

		.align 	2

_Resonant_mult_calc2_CLAasm:
;		MDEBUGSTOP
        ...
        MMOV32      MR0, *MAR0+[Resonant_struct.input]
