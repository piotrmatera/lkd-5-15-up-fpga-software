...
//TODO Tu wpisac wartosci rejestow, obecnie wartosci takie jak po reset
    ...
    0x0,   //0c: D1LVL: DESAT disable and DESAT1 voltage theshold level (0x1f)
    8,      //0d: D1FILT: DESAT1 filter time and type (8)
    0x0,   //0e: D2LVL: DESAT2 enable during TLTOff, influence on fault off, and volt. threshold level (0x10)
