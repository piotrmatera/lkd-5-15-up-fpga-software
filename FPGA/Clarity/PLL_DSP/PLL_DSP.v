...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_DSP -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type pll -fin 20 -fclkop 200 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -fb_mode 1 -fdc C:/Users/MrTea/workspace_v10/SKJEE/FPGA/Clarity/PLL_DSP/PLL_DSP.fdc  */
/* Thu May 18 09:04:54 2023 */


`timescale 1 ns / 1 ps
module PLL_DSP (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
