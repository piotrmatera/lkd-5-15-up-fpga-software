...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL_DSP -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25 -fclkop 175 -fclkop_tol 0.0 -phase_cntl STATIC -fb_mode 1 -fdc C:/Users/MrTea/workspace_v10/SKJEE/FPGA/Clarity/PLL_DSP/PLL_DSP.fdc  */
/* Wed May 10 22:11:06 2023 */


`timescale 1 ns / 1 ps
module PLL_DSP (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOP="175.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 175.000000
